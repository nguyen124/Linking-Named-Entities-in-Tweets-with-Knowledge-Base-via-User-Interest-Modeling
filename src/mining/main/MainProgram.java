...
public class MainProgram {
	 ...
	 public static String en1 = "Sun";
	 public static String en2 = "McNealy";*/

	public static String tweet = "Messi is such a nightmare for Real";
	...
	public static void main(String[] args) {
		...
		Set<String> commonCandidates = new HashSet<String>();
		commonCandidates.addAll(entity1.getCandidates());
		Entity entity2 = EntityService.buildEntity(en2);
		commonCandidates.retainAll(entity2.getCandidates());

		if (commonCandidates.size() > 0) {
			for (String can : commonCandidates) {
				entity1.getCandidates().remove(can);
			}
		}
